...
import ViewPlayerVacancyPage from "./pages/ViewPlayerVacancyPage";
  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path="/party/:id" element={isAuthenticated ? <ViewPartyPage /> : <Navigate to="/login" />} />
        <Route path="/player-vacancy/:id" element={<ViewPlayerVacancyPage />} />
      </Routes>
    </Router>
  );
};
